            ...
            <div className="bg-white shadow-lg border border-slate-200 rounded-lg w-full max-w-2xl p-6">
                ...
                {cart.length === 0 ? (
                    ...
                    <div className="space-y-4">
                        {cart.map((item) => {
                            if (item.quantity <= 0) return null; // Use null for no render
                            return (
                                <div
                                    key={item.id}
                        ...
                        <div className="flex justify-end pt-4 gap-3">
                            <button
                                ...
                                className="px-5 py-2 rounded-md cursor-pointer bg-blue-600 text-white hover:bg-red-700 transition-all"
                            >
                                Proceed to Payment
                            </button>
                            <button
