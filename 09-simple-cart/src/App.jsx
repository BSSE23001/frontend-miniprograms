      ...
      <div className="container flex flex-wrap items-center justify-between mx-auto text-slate-800">
          ...
          <ul className="flex flex-col gap-2 mt-2 mb-4 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
              ...
              <div className="relative inline-flex">
                <div >
                    <button 
                    className="inline-grid cursor-pointer min-h-[36px] min-w-[36px] select-none place-items-center rounded-md border border-slate-200 bg-slate-200 text-center align-middle font-sans text-sm font-medium leading-none text-slate-800 transition-all duration-300 ease-in hover:bg-slate-100 hover:bg-slate-100">
                    <svg
